...
add_submodule engine/third_party/external/vulkan-headers/repo https://github.com/KhronosGroup/Vulkan-Headers
add_submodule engine/third_party/external/vulkan_memory_allocator/repo https://github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator
