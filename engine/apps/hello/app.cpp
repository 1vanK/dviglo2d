...
void App::start()
{
    ...
    texture_ = DV_TEXTURE_CACHE->get(base_path + "app_data/textures/tile128.png");
    sprite_batch_ = make_unique<SpriteBatch>();
    font_ = make_unique<SpriteFont>(base_path + "app_data/fonts/ubuntu-r_20_simple.fnt");

    StrUtf8 music_path = base_path + "app_data/audio/in_the_field.mp3";
