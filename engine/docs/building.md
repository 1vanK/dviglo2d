...
git clone --recurse-submodules https://github.com/dviglo2d/dviglo2d repo
...
# Если хотите использовать Clang, а не GCC, тогда -D CMAKE_C_COMPILER=clang-15 -D CMAKE_CXX_COMPILER=clang++-15
